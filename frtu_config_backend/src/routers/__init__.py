...
from src.routers.frtu_modbus_rtu_tcp import router as FRTUModbusRTUTCPInfoRouter
from src.routers.frtu_base_config import router as FRTUBaseConfigRouter
...
def include_router(app):
    ...
    app.include_router(FRTUModbusRTUTCPInfoRouter, prefix='')
    app.include_router(FRTUBaseConfigRouter, prefix='')
